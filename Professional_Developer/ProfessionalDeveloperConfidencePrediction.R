#
# Random trees to predict levels of confidence (1 to 5) per Java Method
# the following features: size of source code, complexity, profession
...
##
# Import data
dataf <- loadAnswers("answerList_Professional_Developer_data.csv");
